...
class evaluation_suit():
    ...
    def eval_chatGPT(self, data):
        ...
        scores = [self.chatgpt_eval.forward(d) for d in data]
...
if __name__ == '__main__':
    ...
    parser.add_argument('--root_path1', type=str, default="/workspace/BLIP/eval/drivelm/output.json", help='path to prediction file')
    parser.add_argument('--root_path2', type=str, default="/workspace/BLIP/eval/drivelm/test_eval.json", help='path to test file')
