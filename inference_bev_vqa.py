...
#### Dataset ####
dataset = bev_drivelm_dataset("/workspace/BLIP/data_thesis/bev_features_t/train",
...
checkpoint = torch.load("/workspace/BLIP/output/BEV_VQA_DriveLM/BLIP_BEV_VQA_DriveLM_v4_new_bev_26.pth")
